...
from entity.util.nlp import vocabprocessor
...
class TFExtractor():
	...
	def __init__(self, documents,vocabulary_filename,ngram = (1,3) ,mindf = 1):
		...
		# print(formatted_vocab_size)
		# print(self.vocabulary_dict)

	def tf(self):
		#print("TF training for " + str(self.ngram))
		self.i=0
	...
	def get_Topics(self,topicdocs,i):
		...
		# # 	temptokens = zip(matrix[i].tolist(), itertools.count())
